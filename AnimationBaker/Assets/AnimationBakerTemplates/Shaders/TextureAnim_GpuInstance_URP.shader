...
Shader "Universal Render Pipeline/TextureAnim_GpuInstance"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
		    ...
		    v2f vert (appdata v, uint vid : SV_VertexID) {
		        ...
		        // Використання часу та випадкового зміщення для отримання псевдовипадкової координати y
		        ...
		        // Використання випадкового зміщення на основі параметра _RandomOffset
		        float y = t + _RandomOffset;
