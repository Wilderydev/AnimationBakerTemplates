...
public class AnimationBaker : MonoBehaviour
{
    ...
    void Bake()
    {
        ...
        {
            index = BakeClip(index, clip, texWidth, skin, mesh, vCount);
        }
    }

    private int BakeClip(int index, AnimationClip clip, int texWidth, SkinnedMeshRenderer skin, Mesh mesh, int vCount)
    {
        try
        {
